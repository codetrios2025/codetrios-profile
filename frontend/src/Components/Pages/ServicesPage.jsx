                    ...
                    <Row>
                        <Col>
                            <div className={Style.pageHead}>
                                <span className={Style.smallTitle} data-aos="fade-up" data-aos-delay="50">WHAT WE DO</span>
                                <h1 className={Style.title} data-aos="fade-up" data-aos-delay="100">Web Design & Development Services</h1>
