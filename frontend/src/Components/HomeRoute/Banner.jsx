...
const HomeBanner = ({data}) =>{
    ...
    return(
        <div className={Style.heroBanner}>
            <img src={HeroImage} fetchPriority="high" loading="eager" decoding="async" alt="CodeTrios web development and digital solutions" width="1920" height="898" className={Style.imgResponsive} />
                    ...
                    <Row>
                        <Col>
                            <div className={Style.detail}>
                                ...
                                <h1 data-aos="fade-up" data-aos-delay="100">Web Development & Digital Solutions <br />That Help Businesses Grow</h1>
                                <div data-aos="fade-up" data-aos-delay="200" className={Style.heroTagline}>
                                    <span>We don’t just build websites <span className={`fade-text ${fade ? "fade-in" : "fade-out"} ${Style.highLight}`}>we {words[index]}.</span></span>
                                </div>
